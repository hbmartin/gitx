...
final class GitXSwiftFeatureTests: XCTestCase {
    ...
    func testLanguageNameClassification() {
        ...
        XCTAssertEqual(PBHighlighting.languageName(forPath: ".clang-format"), "yaml")
        XCTAssertEqual(PBHighlighting.languageName(forPath: "Sources/API.d.ts"), "typescript")
        XCTAssertEqual(PBHighlighting.languageName(forPath: "schema.graphql"), "graphql")
        XCTAssertEqual(PBHighlighting.languageName(forPath: "schema.proto"), "protobuf")
        XCTAssertEqual(PBHighlighting.languageName(forPath: "main.tf"), "terraform")
        XCTAssertEqual(PBHighlighting.languageName(forPath: "build.zig"), "zig")
        XCTAssertEqual(PBHighlighting.languageName(forPath: "mix.exs"), "elixir")
        XCTAssertEqual(PBHighlighting.languageName(forPath: "config.fish"), "fish")
        XCTAssertEqual(PBHighlighting.languageName(forPath: "shell.zsh"), "bash")
        XCTAssertEqual(PBHighlighting.languageName(forPath: "data.json5"), "json")
        XCTAssertEqual(PBHighlighting.languageName(forPath: "Legacy.h"), "objectivec")
        XCTAssertEqual(PBHighlighting.languageName(forPath: "Legacy.m"), "objectivec")
        XCTAssertEqual(PBHighlighting.languageName(forPath: "rules.pro"), "prolog")
        XCTAssertEqual(PBHighlighting.languageName(forPath: "app.properties"), "properties")
