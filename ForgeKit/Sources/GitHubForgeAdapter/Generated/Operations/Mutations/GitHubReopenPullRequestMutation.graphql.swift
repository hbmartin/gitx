...
extension GitHubAPI {
  nonisolated struct GitHubReopenPullRequestMutation: GraphQLMutation {
    static let operationName: String = "GitHubReopenPullRequest"
    static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"mutation GitHubReopenPullRequest($input: UpdatePullRequestInput!) { updatePullRequest(input: $input) { __typename pullRequest { __typename ...GitHubPullRequestMutationSnapshot id number title body state isDraft createdAt updatedAt closedAt mergedAt headRefName headRefOid headRepository { __typename ...GitHubRepositoryIdentity } baseRefName baseRefOid baseRepository { __typename ...GitHubRepositoryIdentity } } } }"#,
        fragments: [GitHubPullRequestMutationSnapshot.self, GitHubRepositoryIdentity.self]
      ))

    public var input: UpdatePullRequestInput

    public init(input: UpdatePullRequestInput) {
      self.input = input
    }
    ...
    nonisolated struct Data: GitHubAPI.SelectionSet {
      ...
      static var __selections: [ApolloAPI.Selection] { [
        .field("updatePullRequest", UpdatePullRequest?.self, arguments: ["input": .variable("input")]),
      ] }
      static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
        GitHubReopenPullRequestMutation.Data.self
      ] }

      var updatePullRequest: UpdatePullRequest? { __data["updatePullRequest"] }

      /// UpdatePullRequest
      nonisolated struct UpdatePullRequest: GitHubAPI.SelectionSet {
        let __data: DataDict
        init(_dataDict: DataDict) { __data = _dataDict }

        static var __parentType: any ApolloAPI.ParentType { GitHubAPI.Objects.UpdatePullRequestPayload }
        static var __selections: [ApolloAPI.Selection] { [
          .field("__typename", String.self),
          .field("pullRequest", PullRequest?.self),
        ] }
        static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
          GitHubReopenPullRequestMutation.Data.UpdatePullRequest.self
        ] }
        ...
        nonisolated struct PullRequest: GitHubAPI.SelectionSet {
          ...
          static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
            GitHubReopenPullRequestMutation.Data.UpdatePullRequest.PullRequest.self
          ] }
          ...
          /// UpdatePullRequest.PullRequest.HeadRepository
          nonisolated struct HeadRepository: GitHubAPI.SelectionSet {
            ...
            static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
              GitHubReopenPullRequestMutation.Data.UpdatePullRequest.PullRequest.HeadRepository.self,
          ...
          /// UpdatePullRequest.PullRequest.BaseRepository
          nonisolated struct BaseRepository: GitHubAPI.SelectionSet {
            ...
            static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
              GitHubReopenPullRequestMutation.Data.UpdatePullRequest.PullRequest.BaseRepository.self,
              GitHubRepositoryIdentity.self
            ] }
