...
extension GitHubAPI {
  nonisolated struct GitHubClosePullRequestMutation: GraphQLMutation {
    static let operationName: String = "GitHubClosePullRequest"
    static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"mutation GitHubClosePullRequest($input: UpdatePullRequestInput!) { updatePullRequest(input: $input) { __typename pullRequest { __typename ...GitHubPullRequestMutationSnapshot id number title body state isDraft createdAt updatedAt closedAt mergedAt headRefName headRefOid headRepository { __typename ...GitHubRepositoryIdentity } baseRefName baseRefOid baseRepository { __typename ...GitHubRepositoryIdentity } } } }"#,
    ...
    nonisolated struct Data: GitHubAPI.SelectionSet {
      ...
      static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
        GitHubClosePullRequestMutation.Data.self
      ] }
      ...
      nonisolated struct UpdatePullRequest: GitHubAPI.SelectionSet {
        ...
        static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
          GitHubClosePullRequestMutation.Data.UpdatePullRequest.self
        ] }
        ...
        nonisolated struct PullRequest: GitHubAPI.SelectionSet {
          ...
          static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
            GitHubClosePullRequestMutation.Data.UpdatePullRequest.PullRequest.self
          ] }
          ...
          nonisolated struct HeadRepository: GitHubAPI.SelectionSet {
            ...
            static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
              GitHubClosePullRequestMutation.Data.UpdatePullRequest.PullRequest.HeadRepository.self,
          ...
          nonisolated struct BaseRepository: GitHubAPI.SelectionSet {
            ...
            static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
              GitHubClosePullRequestMutation.Data.UpdatePullRequest.PullRequest.BaseRepository.self,
              GitHubRepositoryIdentity.self
            ] }
