...
extension GitHubAPI {
  nonisolated struct GitHubLeaveMergeQueueMutation: GraphQLMutation {
    static let operationName: String = "GitHubLeaveMergeQueue"
    static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"mutation GitHubLeaveMergeQueue($input: DequeuePullRequestInput!) { dequeuePullRequest(input: $input) { __typename mergeQueueEntry { __typename id pullRequest { __typename id number headRefOid repository { __typename ...GitHubRepositoryIdentity } } } } }"#,
        fragments: [GitHubRepositoryIdentity.self]
      ))

    public var input: DequeuePullRequestInput

    public init(input: DequeuePullRequestInput) {
      self.input = input
    }
    ...
    nonisolated struct Data: GitHubAPI.SelectionSet {
      ...
      static var __selections: [ApolloAPI.Selection] { [
        .field("dequeuePullRequest", DequeuePullRequest?.self, arguments: ["input": .variable("input")]),
      ] }
      static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
        GitHubLeaveMergeQueueMutation.Data.self
      ] }

      var dequeuePullRequest: DequeuePullRequest? { __data["dequeuePullRequest"] }

      /// DequeuePullRequest
      nonisolated struct DequeuePullRequest: GitHubAPI.SelectionSet {
        let __data: DataDict
        init(_dataDict: DataDict) { __data = _dataDict }

        static var __parentType: any ApolloAPI.ParentType { GitHubAPI.Objects.DequeuePullRequestPayload }
        static var __selections: [ApolloAPI.Selection] { [
          .field("__typename", String.self),
          .field("mergeQueueEntry", MergeQueueEntry?.self),
        ] }
        static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
          GitHubLeaveMergeQueueMutation.Data.DequeuePullRequest.self
        ] }
        ...
        nonisolated struct MergeQueueEntry: GitHubAPI.SelectionSet {
          ...
          static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
            GitHubLeaveMergeQueueMutation.Data.DequeuePullRequest.MergeQueueEntry.self
          ] }

          var id: GitHubAPI.ID { __data["id"] }
          var pullRequest: PullRequest? { __data["pullRequest"] }

          /// DequeuePullRequest.MergeQueueEntry.PullRequest
          nonisolated struct PullRequest: GitHubAPI.SelectionSet {
            ...
            static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
              GitHubLeaveMergeQueueMutation.Data.DequeuePullRequest.MergeQueueEntry.PullRequest.self
            ] }
            ...
            /// DequeuePullRequest.MergeQueueEntry.PullRequest.Repository
            nonisolated struct Repository: GitHubAPI.SelectionSet {
              ...
              static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
                GitHubLeaveMergeQueueMutation.Data.DequeuePullRequest.MergeQueueEntry.PullRequest.Repository.self,
