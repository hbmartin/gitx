...
extension GitHubAPI {
  nonisolated struct GitHubMergePullRequestMutation: GraphQLMutation {
    static let operationName: String = "GitHubMergePullRequest"
    static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"mutation GitHubMergePullRequest($input: MergePullRequestInput!) { mergePullRequest(input: $input) { __typename pullRequest { __typename ...GitHubPullRequestMutationSnapshot id number title body state isDraft createdAt updatedAt closedAt mergedAt headRefName headRefOid headRepository { __typename ...GitHubRepositoryIdentity } baseRefName baseRefOid baseRepository { __typename ...GitHubRepositoryIdentity } } } }"#,
        fragments: [GitHubPullRequestMutationSnapshot.self, GitHubRepositoryIdentity.self]
      ))

    public var input: MergePullRequestInput

    public init(input: MergePullRequestInput) {
      self.input = input
    }
    ...
    nonisolated struct Data: GitHubAPI.SelectionSet {
      ...
      static var __selections: [ApolloAPI.Selection] { [
        .field("mergePullRequest", MergePullRequest?.self, arguments: ["input": .variable("input")]),
      ] }
      static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
        GitHubMergePullRequestMutation.Data.self
      ] }

      var mergePullRequest: MergePullRequest? { __data["mergePullRequest"] }

      /// MergePullRequest
      nonisolated struct MergePullRequest: GitHubAPI.SelectionSet {
        let __data: DataDict
        init(_dataDict: DataDict) { __data = _dataDict }

        static var __parentType: any ApolloAPI.ParentType { GitHubAPI.Objects.MergePullRequestPayload }
        static var __selections: [ApolloAPI.Selection] { [
          .field("__typename", String.self),
          .field("pullRequest", PullRequest?.self),
        ] }
        static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
          GitHubMergePullRequestMutation.Data.MergePullRequest.self
        ] }
        ...
        nonisolated struct PullRequest: GitHubAPI.SelectionSet {
          ...
          static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
            GitHubMergePullRequestMutation.Data.MergePullRequest.PullRequest.self
          ] }
          ...
          /// MergePullRequest.PullRequest.HeadRepository
          nonisolated struct HeadRepository: GitHubAPI.SelectionSet {
            ...
            static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
              GitHubMergePullRequestMutation.Data.MergePullRequest.PullRequest.HeadRepository.self,
          ...
          /// MergePullRequest.PullRequest.BaseRepository
          nonisolated struct BaseRepository: GitHubAPI.SelectionSet {
            ...
            static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
              GitHubMergePullRequestMutation.Data.MergePullRequest.PullRequest.BaseRepository.self,
              GitHubRepositoryIdentity.self
            ] }
