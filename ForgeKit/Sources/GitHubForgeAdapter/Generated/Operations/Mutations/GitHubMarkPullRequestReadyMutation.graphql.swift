...
extension GitHubAPI {
  nonisolated struct GitHubMarkPullRequestReadyMutation: GraphQLMutation {
    static let operationName: String = "GitHubMarkPullRequestReady"
    static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"mutation GitHubMarkPullRequestReady($input: MarkPullRequestReadyForReviewInput!) { markPullRequestReadyForReview(input: $input) { __typename pullRequest { __typename ...GitHubPullRequestMutationSnapshot id number title body state isDraft createdAt updatedAt closedAt mergedAt headRefName headRefOid headRepository { __typename ...GitHubRepositoryIdentity } baseRefName baseRefOid baseRepository { __typename ...GitHubRepositoryIdentity } } } }"#,
        fragments: [GitHubPullRequestMutationSnapshot.self, GitHubRepositoryIdentity.self]
      ))

    public var input: MarkPullRequestReadyForReviewInput

    public init(input: MarkPullRequestReadyForReviewInput) {
      self.input = input
    }
    ...
    nonisolated struct Data: GitHubAPI.SelectionSet {
      ...
      static var __selections: [ApolloAPI.Selection] { [
        .field("markPullRequestReadyForReview", MarkPullRequestReadyForReview?.self, arguments: ["input": .variable("input")]),
      ] }
      static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
        GitHubMarkPullRequestReadyMutation.Data.self
      ] }

      var markPullRequestReadyForReview: MarkPullRequestReadyForReview? { __data["markPullRequestReadyForReview"] }

      /// MarkPullRequestReadyForReview
      nonisolated struct MarkPullRequestReadyForReview: GitHubAPI.SelectionSet {
        let __data: DataDict
        init(_dataDict: DataDict) { __data = _dataDict }

        static var __parentType: any ApolloAPI.ParentType { GitHubAPI.Objects.MarkPullRequestReadyForReviewPayload }
        static var __selections: [ApolloAPI.Selection] { [
          .field("__typename", String.self),
          .field("pullRequest", PullRequest?.self),
        ] }
        static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
          GitHubMarkPullRequestReadyMutation.Data.MarkPullRequestReadyForReview.self
        ] }
        ...
        nonisolated struct PullRequest: GitHubAPI.SelectionSet {
          ...
          static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
            GitHubMarkPullRequestReadyMutation.Data.MarkPullRequestReadyForReview.PullRequest.self
          ] }
          ...
          /// MarkPullRequestReadyForReview.PullRequest.HeadRepository
          nonisolated struct HeadRepository: GitHubAPI.SelectionSet {
            ...
            static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
              GitHubMarkPullRequestReadyMutation.Data.MarkPullRequestReadyForReview.PullRequest.HeadRepository.self,
          ...
          /// MarkPullRequestReadyForReview.PullRequest.BaseRepository
          nonisolated struct BaseRepository: GitHubAPI.SelectionSet {
            ...
            static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
              GitHubMarkPullRequestReadyMutation.Data.MarkPullRequestReadyForReview.PullRequest.BaseRepository.self,
              GitHubRepositoryIdentity.self
            ] }
