...
extension GitHubAPI {
  nonisolated struct GitHubConvertPullRequestToDraftMutation: GraphQLMutation {
    static let operationName: String = "GitHubConvertPullRequestToDraft"
    static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"mutation GitHubConvertPullRequestToDraft($input: ConvertPullRequestToDraftInput!) { convertPullRequestToDraft(input: $input) { __typename pullRequest { __typename ...GitHubPullRequestMutationSnapshot id number title body state isDraft createdAt updatedAt closedAt mergedAt headRefName headRefOid headRepository { __typename ...GitHubRepositoryIdentity } baseRefName baseRefOid baseRepository { __typename ...GitHubRepositoryIdentity } } } }"#,
        fragments: [GitHubPullRequestMutationSnapshot.self, GitHubRepositoryIdentity.self]
      ))

    public var input: ConvertPullRequestToDraftInput

    public init(input: ConvertPullRequestToDraftInput) {
      self.input = input
    }
    ...
    nonisolated struct Data: GitHubAPI.SelectionSet {
      ...
      static var __selections: [ApolloAPI.Selection] { [
        .field("convertPullRequestToDraft", ConvertPullRequestToDraft?.self, arguments: ["input": .variable("input")]),
      ] }
      static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
        GitHubConvertPullRequestToDraftMutation.Data.self
      ] }

      var convertPullRequestToDraft: ConvertPullRequestToDraft? { __data["convertPullRequestToDraft"] }

      /// ConvertPullRequestToDraft
      nonisolated struct ConvertPullRequestToDraft: GitHubAPI.SelectionSet {
        let __data: DataDict
        init(_dataDict: DataDict) { __data = _dataDict }

        static var __parentType: any ApolloAPI.ParentType { GitHubAPI.Objects.ConvertPullRequestToDraftPayload }
        static var __selections: [ApolloAPI.Selection] { [
          .field("__typename", String.self),
          .field("pullRequest", PullRequest?.self),
        ] }
        static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
          GitHubConvertPullRequestToDraftMutation.Data.ConvertPullRequestToDraft.self
        ] }
        ...
        nonisolated struct PullRequest: GitHubAPI.SelectionSet {
          ...
          static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
            GitHubConvertPullRequestToDraftMutation.Data.ConvertPullRequestToDraft.PullRequest.self
          ] }
          ...
          /// ConvertPullRequestToDraft.PullRequest.HeadRepository
          nonisolated struct HeadRepository: GitHubAPI.SelectionSet {
            ...
            static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
              GitHubConvertPullRequestToDraftMutation.Data.ConvertPullRequestToDraft.PullRequest.HeadRepository.self,
          ...
          /// ConvertPullRequestToDraft.PullRequest.BaseRepository
          nonisolated struct BaseRepository: GitHubAPI.SelectionSet {
            ...
            static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
              GitHubConvertPullRequestToDraftMutation.Data.ConvertPullRequestToDraft.PullRequest.BaseRepository.self,
              GitHubRepositoryIdentity.self
            ] }
