...
extension GitHubAPI {
  nonisolated struct GitHubCreatePullRequestMutation: GraphQLMutation {
    static let operationName: String = "GitHubCreatePullRequest"
    static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"mutation GitHubCreatePullRequest($input: CreatePullRequestInput!) { createPullRequest(input: $input) { __typename pullRequest { __typename ...GitHubPullRequestMutationSnapshot id number title body state isDraft createdAt updatedAt closedAt mergedAt headRefName headRefOid headRepository { __typename ...GitHubRepositoryIdentity } baseRefName baseRefOid baseRepository { __typename ...GitHubRepositoryIdentity } } } }"#,
        fragments: [GitHubPullRequestMutationSnapshot.self, GitHubRepositoryIdentity.self]
      ))

    public var input: CreatePullRequestInput

    public init(input: CreatePullRequestInput) {
      self.input = input
    }
    ...
    nonisolated struct Data: GitHubAPI.SelectionSet {
      ...
      static var __selections: [ApolloAPI.Selection] { [
        .field("createPullRequest", CreatePullRequest?.self, arguments: ["input": .variable("input")]),
      ] }
      static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
        GitHubCreatePullRequestMutation.Data.self
      ] }

      var createPullRequest: CreatePullRequest? { __data["createPullRequest"] }

      /// CreatePullRequest
      nonisolated struct CreatePullRequest: GitHubAPI.SelectionSet {
        let __data: DataDict
        init(_dataDict: DataDict) { __data = _dataDict }

        static var __parentType: any ApolloAPI.ParentType { GitHubAPI.Objects.CreatePullRequestPayload }
        static var __selections: [ApolloAPI.Selection] { [
          .field("__typename", String.self),
          .field("pullRequest", PullRequest?.self),
        ] }
        static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
          GitHubCreatePullRequestMutation.Data.CreatePullRequest.self
        ] }
        ...
        nonisolated struct PullRequest: GitHubAPI.SelectionSet {
          ...
          static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
            GitHubCreatePullRequestMutation.Data.CreatePullRequest.PullRequest.self
          ] }
          ...
          /// CreatePullRequest.PullRequest.HeadRepository
          nonisolated struct HeadRepository: GitHubAPI.SelectionSet {
            ...
            static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
              GitHubCreatePullRequestMutation.Data.CreatePullRequest.PullRequest.HeadRepository.self,
          ...
          /// CreatePullRequest.PullRequest.BaseRepository
          nonisolated struct BaseRepository: GitHubAPI.SelectionSet {
            ...
            static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
              GitHubCreatePullRequestMutation.Data.CreatePullRequest.PullRequest.BaseRepository.self,
              GitHubRepositoryIdentity.self
            ] }
