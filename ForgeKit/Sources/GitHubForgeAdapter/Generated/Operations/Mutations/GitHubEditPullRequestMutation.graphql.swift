...
extension GitHubAPI {
  nonisolated struct GitHubEditPullRequestMutation: GraphQLMutation {
    static let operationName: String = "GitHubEditPullRequest"
    static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"mutation GitHubEditPullRequest($input: UpdatePullRequestInput!) { updatePullRequest(input: $input) { __typename pullRequest { __typename ...GitHubPullRequestMutationSnapshot id number title body state isDraft createdAt updatedAt closedAt mergedAt headRefName headRefOid headRepository { __typename ...GitHubRepositoryIdentity } baseRefName baseRefOid baseRepository { __typename ...GitHubRepositoryIdentity } } } }"#,
    ...
    nonisolated struct Data: GitHubAPI.SelectionSet {
      ...
      static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
        GitHubEditPullRequestMutation.Data.self
      ] }
      ...
      nonisolated struct UpdatePullRequest: GitHubAPI.SelectionSet {
        ...
        static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
          GitHubEditPullRequestMutation.Data.UpdatePullRequest.self
        ] }
        ...
        nonisolated struct PullRequest: GitHubAPI.SelectionSet {
          ...
          static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
            GitHubEditPullRequestMutation.Data.UpdatePullRequest.PullRequest.self
          ] }
          ...
          nonisolated struct HeadRepository: GitHubAPI.SelectionSet {
            ...
            static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
              GitHubEditPullRequestMutation.Data.UpdatePullRequest.PullRequest.HeadRepository.self,
          ...
          nonisolated struct BaseRepository: GitHubAPI.SelectionSet {
            ...
            static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
              GitHubEditPullRequestMutation.Data.UpdatePullRequest.PullRequest.BaseRepository.self,
              GitHubRepositoryIdentity.self
            ] }
